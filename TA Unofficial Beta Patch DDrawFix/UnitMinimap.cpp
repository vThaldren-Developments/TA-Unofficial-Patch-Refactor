...
void UnitsMinimap::LoadUnitPicture ( void)
{
			...
			{// if not null, use default
				...
				if (CategoryNameAry)
				{
					...
					if (0<MaskNum)
					{
						...
						{
							if ('\0'!=myExternHotKey->Commanders[i][0])
							{
								wsprintfA ( ConfigFileName, "%s\\%s.PCX", ConfigFilePath, &myExternHotKey->Commanders[i][0]);
								if (0xffffffff!=GetFileAttributesA ( ConfigFileName))
								{
									MaskAry[MaskNum]= myExternHotKey->CommandersMask[i];
	...
	for (int i= 0; i<RACENUMBER; ++i)
	{
		if ('\0'!=myExternHotKey->Commanders[i][0])
		{
			wsprintfA ( ConfigFilePath, "%s\\%s.PCX", TAPath, &myExternHotKey->Commanders[i][0]);
			if (0xffffffff!=GetFileAttributesA ( ConfigFilePath))
			{
				MaskAry[MaskNum]= myExternHotKey->CommandersMask[i];
	...
	if (0xffffffff!=GetFileAttributesA ( ConfigFilePath))
	{
		MaskAry[MaskNum]= myExternHotKey->CommanderMask;
		PicturesBits[MaskNum]= new UnitIcon( ConfigFilePath);
		MaskNum++;
	}
	...
	if (0xffffffff!=GetFileAttributesA ( ConfigFilePath))
	{
		MaskAry[MaskNum]= myExternHotKey->AirWeaponMask;
		PicturesBits[MaskNum]= new UnitIcon( ConfigFilePath);
		MaskNum++;
	}
	...
	if (0xffffffff!=GetFileAttributesA ( ConfigFilePath))
	{
		MaskAry[MaskNum]= myExternHotKey->AirConMask;
		PicturesBits[MaskNum]= new UnitIcon( ConfigFilePath);
		MaskNum++;
	}
	...
	if (0xffffffff!=GetFileAttributesA ( ConfigFilePath))
	{
		MaskAry[MaskNum]= myExternHotKey->ConstructorMask;
		PicturesBits[MaskNum]= new UnitIcon( ConfigFilePath);
		MaskNum++;
	}
	...
	if (0xffffffff!=GetFileAttributesA ( ConfigFilePath))
	{
		MaskAry[MaskNum]= myExternHotKey->MobileWeaponMask;
		PicturesBits[MaskNum]= new UnitIcon( ConfigFilePath);
		MaskNum++;
	}
	...
	if (0xffffffff!=GetFileAttributesA ( ConfigFilePath))
	{
		MaskAry[MaskNum]= myExternHotKey->FactoryMask;
		PicturesBits[MaskNum]= new UnitIcon( ConfigFilePath);
		MaskNum++;
	}
	...
	if (0xffffffff!=GetFileAttributesA ( ConfigFilePath))
	{
		MaskAry[MaskNum]= myExternHotKey->BuildingMask;
		PicturesBits[MaskNum]= new UnitIcon( ConfigFilePath);
		MaskNum++;
	}
