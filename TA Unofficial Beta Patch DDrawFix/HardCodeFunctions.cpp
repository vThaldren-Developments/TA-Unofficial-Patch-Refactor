...
bool DrawTextInScreen_ez (OFFSCREEN * offscreen_p, char *text, int y_off, int x_off)
{
	return DrawColorTextInScreen( offscreen_p, text, y_off, x_off, -1, 0);
}

void resumeScreenPlatte (void)
{

	updateGammeSetting (0.5f -  (*TAmainStruct_PtrPtr)->gammeV  * -0.041666668f);
	
/*

	ÐÞ¸ÄgammaÖµ
		*(float *)&v5 = 0.5 - (double)*(signed int *)(dword_511DE8 + 229128) * -0.041666668;
	sub_4BA590(v5);*/
}

void resumeOffScreen ()
{
...
_unkIntAVoidFunc CreateNewDDSurface=  (_unkIntAVoidFunc)0x4B5910;
_unkIntAVoidFunc OffScreenUpdate_1= (_unkIntAVoidFunc)0x4C2470;
_unkIntAVoidFunc OffScreenUpdate_2=  (_unkIntAVoidFunc)0x4C2870;
_unkIntAVoidFunc OffScreenUpdate_3=  (_unkIntAVoidFunc)0x4C63A0;
_setOffScreen setOffScreen =(_setOffScreen) 0x4C69A0;
_updateGammeSetting updateGammeSetting= (_updateGammeSetting)0x4BA590;
_tick_AIFrame tick_AIFrame= (_tick_AIFrame) 0x0464F80;
...
LPBYTE AddrOrginalPathFind = (LPBYTE)0x0497C10  ;
