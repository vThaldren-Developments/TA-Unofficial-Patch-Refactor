...
/// Working.
//////////////////////////////////////////////////////////////////////////////////////////
typedef int (__stdcall * _unkIntAVoidFunc)();
typedef int (__stdcall * _unkIntAIntFunc)(int);
extern _unkIntAVoidFunc CreateNewDDSurface;
extern _unkIntAVoidFunc OffScreenUpdate_1;
extern _unkIntAVoidFunc OffScreenUpdate_2;
extern _unkIntAVoidFunc OffScreenUpdate_3;
typedef int (__stdcall * _setOffScreen)(OFFSCREEN * newOff);
extern _setOffScreen setOffScreen;

typedef int (__stdcall * _updateGammeSetting)(float gammeV);
extern _updateGammeSetting updateGammeSetting;

typedef int(__stdcall *_tick_AIFrame)();
extern _tick_AIFrame tick_AIFrame;
...
extern LPBYTE AddrOrginalPathFind;
